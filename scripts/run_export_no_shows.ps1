# تشغيل تصدير أرقام المسجّلين إلكترونياً الموثّقين يلي ما دخلوا البوابة ولا مرة.
# نفس فكرة run_export.ps1 بس بيصدّر export_registered_no_shows.py.
#
# الاستخدام:
#     powershell -ExecutionPolicy Bypass -File scripts\run_export_no_shows.ps1

$ErrorActionPreference = "Stop"
$script = Join-Path $PSScriptRoot "export_registered_no_shows.py"
