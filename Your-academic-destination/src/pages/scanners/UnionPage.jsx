...
const UnionPage = () => {
  ...
  useEffect(() => {
    apiGet('/checkins/count/today?activity_type=union')
  ...
  const handleScan = async (rawCode) => {
    ...
    try {
      const response = await apiPost('/checkins/union', { unique_code: code });
      setResult({
        status: 'success',
        title: 'الاتحاد',
      ...
      <div className="card-container">
        ...
        <main className="card-body">
          ...
          <p className="scan-rule-text">
            يكفي أن يدخل الطالب إلى الجامعة اليوم لآلة مسح الاتحاد — والمسح يُسجَّل مرة وحدة لكل طالب طوال الفعالية.
          </p>
        </main>
