...
// قائمة الكليات الكاملة — نفس قيم (id) enum College بالباك وبنفس ترتيبه المعتمد.
const KNOWN_COLLEGES = [
  { value: 'medicine', label: 'الطب البشري' },
  { value: 'pharmacy', label: 'الصيدلة' },
  { value: 'dentistry', label: 'طب الأسنان' },
  { value: 'health_labs', label: 'علوم صحيّة مخابر' },
  { value: 'health_nutrition', label: 'علوم صحيّة تغذية' },
  { value: 'health_physiotherapy', label: 'علوم صحية علاج فيزيائي' },
  { value: 'mech_power_eng', label: 'هندسة قوى ميكانيكية' },
  { value: 'control_computer_eng', label: 'هندسة تحكم آلي وحواسيب' },
  { value: 'energy_eng', label: 'هندسة طاقة' },
  { value: 'mechatronics', label: 'ميكاترونك' },
  { value: 'telecom_eng', label: 'هندسة اتصالات' },
  { value: 'metallurgy_eng', label: 'هندسة المعادن' },
  { value: 'design_production_eng', label: 'هندسة التصميم والإنتاج' },
  { value: 'petroleum_eng', label: 'هندسة بيتروليّة' },
  { value: 'food_eng', label: 'هندسة غذائية' },
  { value: 'chemical_eng', label: 'هندسة كيميائية' },
  { value: 'textile_eng', label: 'هندسة الغزل والنسيج' },
  { value: 'civil', label: 'هندسة مدنيّة' },
  { value: 'tourism', label: 'سياحة' },
  { value: 'architecture', label: 'هندسة معماريّة' },
  { value: 'music', label: 'موسيقا' },
  { value: 'physics', label: 'فيزياء' },
  { value: 'mathematics', label: 'رياضيات' },
  { value: 'statistics', label: 'إحصاء' },
  { value: 'biology', label: 'علم الحياة بيولوجيا' },
  { value: 'geology', label: 'علم الحياة جيولوجيا' },
  { value: 'chemistry', label: 'كيمياء' },
  { value: 'economics', label: 'اقتصاد' },
  { value: 'informatics', label: 'هندسة معلوماتية' },
  { value: 'applied_science', label: 'كلية تطبيقية' },
  { value: 'arabic', label: 'لغة عربية' },
  { value: 'english', label: 'لغة انكليزية' },
  { value: 'french', label: 'لغة فرنسية' },
  { value: 'persian', label: 'لغة فارسية' },
  { value: 'history', label: 'تاريخ' },
  { value: 'philosophy', label: 'فلسفة' },
  { value: 'agriculture', label: 'هندسة زراعية' },
  { value: 'law', label: 'حقوق' },
  { value: 'curricula', label: 'مناهج وطرق تدريس' },
  { value: 'psychology', label: 'علم نفس' },
  { value: 'kindergarten', label: 'رياض أطفال' },
  { value: 'psychological_counseling', label: 'إرشاد نفسي' },
  { value: 'class_teacher', label: 'معلم صف' },
  { value: 'sharia', label: 'شريعة' },
