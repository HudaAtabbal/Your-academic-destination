...
import UnionPage from "./pages/scanners/UnionPage";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/team-union" element={<TeamPrivateRoute><UnionPage/></TeamPrivateRoute>}/>
        ...
        <Route path="/dashboard-survey-completions" element={<TeamPrivateRoute><SurveyCompletionsPage/></TeamPrivateRoute>}/>
